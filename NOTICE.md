...
This project's LSPosed module (`app/`) contains AGSL/SKSL shader source
...
- **Kyant0/AndroidLiquidGlass** — https://github.com/Kyant0/AndroidLiquidGlass
  ...
  shaders (`app/.../shader/GlassShaders.kt`).
...
- **chrisbanes/haze** — https://github.com/chrisbanes/haze
  ...
  (`app/.../shader/NoiseTintShader.kt`,
  `app/.../res/drawable-nodpi/glass_noise.webp`).
